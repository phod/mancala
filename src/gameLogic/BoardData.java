...
public class BoardData {
    ...
    /**
     * Creates a board with 2 sides, 6 holes on each side, and 2
     * mancala holes. Each hole (excluding mancalas) is filled with
     * 4 pieces. 
     */
    public BoardData() {
    ...
    /**
     * Adds the specified number of pieces to the specified hole.
     * This method does <em>not</em> add to mancala holes.
     *
    ...
    /**
     * Returns the number of pieces in the specified hole.
     * This method does <em>not</em> retrieve from mancala holes.
     *
     ...
     * @throws InvalidSideException TODO
     * @throws InvalidPositionExcpetion TODO
     */
